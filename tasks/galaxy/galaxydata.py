workflows = [
    ...
    },
    {
        ...
        'searchtype': 'standard',
        'required_params': ['setpatterns', 'setnames', 'intercepts',
                            'fr_widths', 'strippatterns', 'perco_ids',
                            'ppoolsize',],
        'required_dsets': ['sourcehis'],
    ...
    },
    {
        ...
        'name': 'rerun IPG tmt10, ENSEMBL, QE', 'modules': [
            ...
            'protein isobaric', 'symbol isobaric'],
        'rerun_rename_labels': {
            x: False for x in ['quant lookup', 'msgf target', 'msgf decoy',
                               'msgf tsv target', 'msgf tsv decoy',
                               'target db', 'decoy db']},
        'searchtype': 'standard',
        'not_outputs': [],
    },
